...
# Plot loss
print('Name:BARATH')
print('Register Number:212225240023')
...
print('Name:SUMITH M')
print('Register Number:212224230279')
...
## Loss Vs Epoch Plot
<img width="1097" height="716" alt="image" src="https://github.com/user-attachments/assets/9e5d7ff0-f03e-4013-b9da-d6c678ebe12a" />


### Sample Text Prediction
<img width="528" height="577" alt="image" src="https://github.com/user-attachments/assets/61c641ce-b39b-42c6-a100-cf4c0515ec34" />


## RESULT
An lstm model to recoganize named entity is done succesfully
